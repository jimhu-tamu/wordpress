...
this.symmetry.toFractional (pt, false);
this.setSymmetryMinMax (pt);
this.minXYZ = JU.P3i.new3 (Clazz_doubleToInt (Math.floor (this.rminx)), Clazz_doubleToInt (Math.floor (this.rminy)), Clazz_doubleToInt (Math.floor (this.rminz)));
this.maxXYZ = JU.P3i.new3 (Clazz_doubleToInt (Math.ceil (this.rmaxx)), Clazz_doubleToInt (Math.ceil (this.rmaxy)), Clazz_doubleToInt (Math.ceil (this.rmaxz)));
