...
Clazz.defineEnumConstant (c$, "SERVICE", 13, []);
Clazz.defineEnumConstant (c$, "PICK", 14, []);
Clazz.defineEnumConstant (c$, "RESIZE", 15, []);
Clazz.defineEnumConstant (c$, "SCRIPT", 16, []);
Clazz.defineEnumConstant (c$, "SYNC", 17, []);
Clazz.defineEnumConstant (c$, "STRUCTUREMODIFIED", 18, []);
});
