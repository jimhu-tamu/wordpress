...
Clazz.defineMethod (c$, "mutate", 
 function () {
if (this.tokAt (1) == 2) this.st[1] = JS.T.o (4, "" + this.st[1].value);
var iatom = this.atomExpressionAt (1).length () - 1;
if (iatom < 0 || this.vwr.ms.mc != this.vwr.ms.at[iatom].mi + 1) return;
var i = ++this.e.iToken;
var group = this.e.optParameterAsString (this.e.checkLast (i));
if (this.chk) return;
if (this.tokAt (i) != 4) group = "==" + group;
this.vwr.getJBR ().mutate (iatom, group);
});
