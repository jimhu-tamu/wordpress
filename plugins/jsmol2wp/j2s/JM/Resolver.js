...
function (iatom, fileName) {
var info = this.vwr.fm.getFileInfo ();
var b = this.vwr.getBoolean (603979792);
var g = this.vwr.ms.at[iatom].group;
...
if (this.vwr.ms.ac == ac) return false;
g = this.vwr.ms.at[this.vwr.ms.ac - 1].group;
if (g !== this.vwr.ms.at[ac + 1].group || !(Clazz.instanceOf (g, JM.AminoMonomer))) {
var bsAtoms =  new JU.BS ();
g.selectAtoms (bsAtoms);
this.vwr.deleteAtoms (bsAtoms, false);
return false;
}var res1 = g;
...
var bsExclude = JU.BSUtil.newBitSet2 (0, this.vwr.ms.mc);
bsExclude.clear (res1.chain.model.modelIndex);
res1.chain.model.groupCount = -1;
this.vwr.ms.recalculatePolymers (bsExclude);
this.vwr.setBooleanProperty ("appendNew", b);
this.vwr.fm.setFileInfo (info);
return true;
}, "~N,~S");
